...
const contentSecurityPolicy = [
  ...
  "form-action 'self'",
  `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.youtube.com https://www.youtube-nocookie.com https://s.ytimg.com${supabaseCspSource}`,
  `style-src 'self' 'unsafe-inline'${supabaseCspSource}`,
  `img-src 'self' data: blob: https:${supabaseCspSource}`,
