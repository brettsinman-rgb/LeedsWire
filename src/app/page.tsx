  ...
  return (
    <PageShell>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
        ...
        <section
          id="media"
          className="rounded-[1.15rem] bg-[radial-gradient(circle_at_82%_8%,rgba(255,221,0,0.08),transparent_26%),linear-gradient(135deg,rgba(14,29,48,0.88)_0%,rgba(8,24,42,0.84)_100%)] px-5 py-8 shadow-[0_22px_68px_rgba(0,0,0,0.22)] ring-1 ring-white/[0.08] sm:px-8 sm:py-10 lg:px-10"
        >
          <div className="mb-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="w-full lg:max-w-xl">
              <MediaChannelNav title="Watch by channel" />
            </div>
          </div>
