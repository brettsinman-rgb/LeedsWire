        ...
        <article className="shine-card group relative overflow-hidden rounded-[1.25rem] bg-[#0b1726]/78 shadow-[0_26px_82px_rgba(0,0,0,0.26)] ring-1 ring-white/[0.08] backdrop-blur lg:max-h-[800px]">
          <div className="grid lg:h-[clamp(29rem,49vh,32rem)] lg:grid-cols-[1.35fr_0.82fr]">
            ...
            <div className="flex flex-col bg-[linear-gradient(145deg,rgba(14,29,48,0.96)_0%,rgba(8,24,42,0.92)_100%)] p-6 sm:p-8 lg:min-h-0 lg:px-7 lg:py-6">
              <div className="flex flex-1 flex-col justify-center overflow-hidden lg:justify-start">
                <p className="mb-4 text-xs font-bold uppercase tracking-[0.22em] text-[#ffdd00] lg:mb-2">
                  Top Story
                </p>
                <h1 className="line-clamp-2 text-2xl font-semibold leading-[1.03] tracking-tight text-white sm:line-clamp-4 sm:text-5xl lg:text-5xl">
                  {article.title}
                </h1>
                <p className="mt-5 line-clamp-3 max-w-2xl text-base leading-7 text-zinc-300 lg:mt-3 lg:line-clamp-2">
                  {shortExcerpt}
                </p>
              </div>
              <div className="mt-auto pt-8 lg:pt-3">
